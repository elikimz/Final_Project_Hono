...
exports.VehicleSpecifications = (0, pg_core_1.pgTable)("vehicle_specifications", {
    ...
    image_url: (0, pg_core_1.varchar)("image_url", { length: 255 }), // Add image_url field
});
...
exports.Locations = (0, pg_core_1.pgTable)("locations", {
    id: (0, pg_core_1.serial)("location_id").primaryKey(),
...
exports.Bookings = (0, pg_core_1.pgTable)("bookings", {
    id: (0, pg_core_1.serial)("booking_id").primaryKey(),
    ...
    location_id: (0, pg_core_1.integer)("location_id").notNull().references(() => exports.Locations.id),
...
exports.Payments = (0, pg_core_1.pgTable)("payments", {
    id: (0, pg_core_1.serial)("payment_id").primaryKey(),
    booking_id: (0, pg_core_1.integer)("booking_id").references(() => exports.Bookings.id),
    ...
    payment_date: (0, pg_core_1.timestamp)("payment_date").defaultNow(),
...
exports.CustomerSupportTickets = (0, pg_core_1.pgTable)("customer_support_tickets", {
    id: (0, pg_core_1.serial)("ticket_id").primaryKey(),
    user_id: (0, pg_core_1.integer)("user_id").notNull().references(() => exports.Users.id),
...
exports.FleetManagement = (0, pg_core_1.pgTable)("fleet_management", {
    id: (0, pg_core_1.serial)("fleet_id").primaryKey(),
    vehicle_id: (0, pg_core_1.integer)("vehicle_id").notNull().references(() => exports.Vehicles.id),
...
exports.Auth = (0, pg_core_1.pgTable)("authentication", {
    id: (0, pg_core_1.serial)("auth_id").primaryKey(),
...
exports.authenticationRelations = (0, drizzle_orm_1.relations)(exports.Auth, ({ one }) => ({
    user: one(exports.Users, {
        fields: [exports.Auth.user_id],
        references: [exports.Users.id],
    }),
}));
