...
export type VehicleSpecificationsInsert = typeof VehicleSpecifications.$inferInsert;
export type VehicleSpecificationsSelect= typeof VehicleSpecifications.$inferSelect;
...
export type CustomerSupportTicketsInsert = typeof CustomerSupportTickets .$inferInsert;
export type CustomerSupportTicketsSelect= typeof CustomerSupportTickets .$inferSelect;

export type FleetManagementInsert = typeof FleetManagement .$inferInsert;
