...
app.route('/vehicalspecification', vehicleSpecificationsRouter);
app.route('/vehicles', VehiclesRouter);
app.route('/locations', LocationsRouter);
app.route('/bookings', BookingsRouter);
app.route('/payments', PaymentsRouter);
app.route('/support-tickets', CustomerSupportTicketsRouter);
app.route('/fleet-management', FleetManagementRouter);
